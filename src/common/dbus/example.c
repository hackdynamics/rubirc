...
#define DBUS_SERVICE "org.rubirc.service"
#define DBUS_REMOTE "/org/rubirc/Remote"
#define DBUS_REMOTE_CONNECTION_INTERFACE "org.rubirc.connection"
#define DBUS_REMOTE_PLUGIN_INTERFACE "org.rubirc.plugin"
		 ...
		 gpointer user_data)
{
	...
	if (hook_id == command_id) {
		...
		/* Now if you write "/test blah" again in the RUBIRC window
...
main (int argc, char **argv)
{
	...
	/* Now you can write on the RUBIRC windows: "/test arg1 arg2 ..." */
