...
#ifndef RUBIRC_CFGFILES_H
#define RUBIRC_CFGFILES_H
...
int rubirc_open_file (const char *file, int flags, int mode, int xof_flags);
FILE *rubirc_fopen_file (const char *file, const char *mode, int xof_flags);
...
#define P_OFFSET(field) STRUCT_OFFSET_STR(struct rubircprefs, field),sizeof(prefs.field)
#define P_OFFSETNL(field) STRUCT_OFFSET_STR(struct rubircprefs, field)
#define P_OFFINT(field) STRUCT_OFFSET_INT(struct rubircprefs, field),0
#define P_OFFINTNL(field) STRUCT_OFFSET_INT(struct rubircprefs, field)
...
#define RUBIRC_SOUND_DIR "sounds"
